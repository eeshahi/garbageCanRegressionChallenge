...
The true model is 
Anxiety = Stress + 0.1 × Time (intercept =0, no StressSurvey term). So even though the bivariate fit looks strong, its intercept is wrong (should be 0) and the slope isn’t the true stress effect (1 on Stress) because StressSurvey is a proxy and omitting Time introduces bias.
